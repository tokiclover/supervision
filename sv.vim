...
syn keyword svKwd begin die end error eval_colors info yesno checkpath SOURCE
syn keyword svKwd env_svc env_sv svc_cmd svc_down svc_env svc_state
...
syn keyword svVars CGROUP_CLEANUP CGROUP_INHERIT SV_CGROUP
